...
/**
 * Port po��czenia pomi�dzy serwerem a klientami.
 * Warto�� sta�a: 1201.
 */
...
/**
 * Tymczasowy strumie� wej�ciowy s�u��cy do wpisywania go jako kolejnego elementu HashMapy outStreams.
 * @see outStreams
 */
private ObjectInputStream tempStreamIn;
/**
 * Tymczasowy strumie� wyj�ciowy s�u��cy do wpisywania go jako kolejnego elementu HashMapy inStreams.
 * @see inStreams
 */
private ObjectOutputStream tempStreamOut;
/**
 * HashMapa gniazdek kolejnych klient�w.
 * @see tempSocket
 */
private HashMap<Integer, Socket> sockets;
/**
 * HashMapa strumieni wyj�ciowych kolejnych klient�w.
 * @see tempStreamOut
 * @see inStreams
 */
private HashMap <Integer, ObjectOutputStream> outStreams;
/**
 * HashMapa strumieni wej�ciowych kolejnych klient�w.
 * @see temoStreamIn
 * @see outStreams
 */
private HashMap <Integer, ObjectInputStream> inStreams;
/**
 * G��wne okno aplikacji serwera.
 */
...
/**
 * Konstruktor g��wnego programu serwera.
 */
public ServerMain()
{
	// LOGGER
 ...
 * Tworzy w�tek kolejnego klienta z przypisanego mu gniazdna oraz zestawu dw�ch strumieni: wej�ciowego i wyj�ciowego.
 * @param s HashMapa (Integer, Socket) bazy gniazdek kolejnych klient�w.
 * @param inMap HashMapa strumieni wej�ciowych klient�w.
 * @param outMap HashMapa strumieni wyj�ciowych klient�w.
 * @param c Okre�lony numer konkretnego klienta.
 */
...
/** Metoda zwracaj�ca HashMap� w�tk�w klient�w.
 * @return HashMapa w�tk�w klient�w.
 */
...
/** Metoda zrzucaj�ca tre�� wyj�tku do pliku Loggera.
 * @param e Wyj�tek.
 */
...
/** Metoda formatuj�ca i wy�wietlaj�ca tre�� wiadomo�ci od klienta w oknie serwera.
